...
class QuestionMapper {
  /**
   * Normalize question title for case-insensitive duplicate checking
   * Example: "   What   is   Node.js?   " => "what is node.js?"
   */
